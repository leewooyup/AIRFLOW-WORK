...
with DAG(
    ...
    bash_task_2 = BashOperator(
        task_id='bask_task_2',
        env={'START_DATE': '{{ data_interval_end.in_timezone("Asia/Seoul") - macros.dateutil.relativedelta.relativedelta(days=19)) | ds }}', # 이전 배치에 돌았던 날짜
